...
local common = {
    ...
    SHADERCOMPILER = "$(OBJECTDIR)$(SEP)shaderc$(PROGSUFFIX)", 
      ...
      CPPDEFS = {
        ...
        {"ENTRY_CONFIG_IMPLEMENT_MAIN=1", "EASTL_NOMINMAX", "EASTL_MINMAX_ENABLED", "EASTL_MOVE_SEMANTICS_ENABLED", "EA_HAVE_CPP11_INITIALIZER_LIST=1"},
      },
      GENERATE_PDB = {
         "1"
      },
